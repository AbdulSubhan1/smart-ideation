...
import Blo1Image from "../../assets/images/bg/1.jpg";
import Blo2Image from "../../assets/images/bg/2.jpg";
import Blo3Image from "../../assets/images/bg/3.jpg";
              ...
              <Col lg={4} md={6} className="mt-4 pt-2">
                <Card className="blog blog-primary shadow rounded overflow-hidden border-0">
                  ...
                  <CardBody className="content p-0">
                    <div className="p-4">
                      <Link to="#" className="h5 title text-dark d-block mb-0">
                        Building Your Corporate Identity from Motos
                      </Link>
                      <p className="text-muted mt-2 mb-0">
                        The most well-known dummy text is the &lsquo;Lorem
                        Ipsum&rsquo;, in the 16th century.
                      </p>
