              ...
              <div className="col-12 filters-group-wrap text-center">
                <div className="filters-group">
                  <ul className="container-filter mb-4 categories-filter list-unstyled filter-options">
                    ...
                    <li
                      className={
                        this.state.activeSection === "Branding"
                          ? "list-inline-item categories h6 position-relative text-dark active"
                          : "list-inline-item categories h6 position-relative text-dark"
                      }
                      data-group="branding"
                      onClick={this.handleClick.bind(this, "Branding")}
                    >
                      Branding
                    </li>
                    <li
                      className={
                        this.state.activeSection === "Designing"
                          ? "list-inline-item categories h6 position-relative text-dark active"
                          : "list-inline-item categories h6 position-relative text-dark"
                      }
                      data-group="designing"
                      onClick={this.handleClick.bind(this, "Designing")}
                    >
                      Designing
                    </li>
                    <li
                      ...
                      onClick={this.handleClick.bind(this, "Photography")}
                    >
                      Photography
                    </li>
                    <li
                      className={
                        this.state.activeSection === "Development"
                          ? "list-inline-item categories h6 position-relative text-dark active"
                          : "list-inline-item categories h6 position-relative text-dark"
                      }
                      data-group="development"
                      onClick={this.handleClick.bind(this, "Development")}
                    >
                      Development
                    </li>
                  </ul>
                  ...
                  <div className="card border-0 project project-primary position-relative d-block overflow-hidden rounded">
                    <div className="card-body p-0">
                      ...
                      <div className="content bg-white p-3 rounded shadow start-0 end-0 bottom-0 m-3">
                        <Link to="#" className="text-dark title h5">
                          {item.title}
                        </Link>
